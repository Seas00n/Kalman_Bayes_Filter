...
sys.path.append("/home/yuxuan/Project/Kalman_Bayes_Filter/Kalman_Bayes_Filter/Project/esekf_imu/")

def load_imu_parameters():
    f = open('/home/yuxuan/Project/Kalman_Bayes_Filter/Kalman_Bayes_Filter/Project/esekf_imu/data/params.yaml', 'r')
...
def main():
    # 真实IMU数据
    imu_data = np.loadtxt('/home/yuxuan/Project/Kalman_Bayes_Filter/Kalman_Bayes_Filter/Project/esekf_imu/data/imu_noise.txt')
    # 实际轨迹数据
    gt_data = np.loadtxt('/home/yuxuan/Project/Kalman_Bayes_Filter/Kalman_Bayes_Filter/Project/esekf_imu/data/traj_gt.txt')
    # 加载IMU参数
